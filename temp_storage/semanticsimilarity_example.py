...
# We want to establish how spaCy's model can identify similarities or dissimilarities between complaints and recipes. 
...
# There are several ways to make your model more accurate
# such as feeding it with some training data. This could include
